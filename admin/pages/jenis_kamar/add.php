...
<div class="data-wrapper">
	<form class="form-horizontal" id="form-jeniskamar">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="nama-jeniskamar" class="form-control" id="nama-jeniskamar" placeholder="nama" required="required">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="deskripsi-jeniskamar">Description</label>
			<div class="col-sm-4">
				<textarea name="deskripsi-jeniskamar" class="form-control" id="deskripsi-jeniskamar"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="hotel-jeniskamar">Hotel <strong>*</strong></label>
			<div class="col-sm-4">
				<input type="text" name="hotel-jeniskamar" class="form-control" id="hotel-jeniskamar" placeholder="nama hotel (Soekarno) " required="required" readonly>
				<input type="hidden" name="hotel-jeniskamar-id" id="hotel-jeniskamar-id" value="0">
			</div>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="">Picture(s) <strong>*</strong></label>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<div class="col-sm-offset-1 col-sm-1">
				<img id="gbr-view<?php _e($i); ?>" src="" alt="" class="gambar-view-jeniskamar" height="50">
			</div>
			<div class="col-sm-3">
				<input id="gbr-fname<?php _e($i); ?>" type="text" name="gambar-url-jeniskamar[]" class="form-control gambar-url-jeniskamar" readonly="readonly" >
				<input id="gbr-id<?php _e($i); ?>" type="hidden" name="gambar-id-jeniskamar[]" value="0" class="gambar-id-jeniskamar">
			</div>
			<div class="col-sm-1">
			...
			<div class="col-sm-2">
				<input id="gbr-radio<?php _e($i); ?>" class='gambar-utama-jeniskamar' type='radio' name='gambar-utama-jeniskamar' value='0'> gambar utama
			</div>
		</div>
		<?php endfor; ?>
		<div class="form-group">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-primary">Hotel</h4>
			</div>
...
jQuery(document).ready( function($) {
	...
	$( "#form-jeniskamar").submit( function(e) {
		...
		if( not_empty ) {
			...
			$.post(
				...
				function( response ) {
					...
					if( result.status ) {
						...
						location.href = "<?php echo admin_url('admin.php?page=sltg-jeniskamar&doaction=create-new&status=success'); ?>";
					}else{
			...
			$( "div.form-message").html( "<p class='text-danger'>Name, Hotel, and Picture(s) are required.</p>");
		}
	});
