...
<div class="data-wrapper">
	<form class="form-horizontal" id="form-craft">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="nama-craft" class="form-control" id="nama-craft" placeholder="nama" required="required">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="deskripsi-craft">Description</label>
			<div class="col-sm-4">
				<textarea name="deskripsi-craft" class="form-control" id="deskripsi-craft"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="info-lain-craft">Other</label>
			<div class="col-sm-4">
				<textarea name="info-lain-craft" class="form-control" id="info-lain-craft"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="kategori-craft">Category <strong>*</strong></label>
			<div class="col-sm-4">
				<input type="text" name="kategori-craft" class="form-control" id="kategori-craft" placeholder="kategori" required="required">
				<input type="hidden" name="kategori-craft-id" id="kategori-craft-id" value="0">
			</div>
			<div class="col-sm-2">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="creator-craft" class="form-control" id="creator-craft" placeholder="nama creator (Soekarno) " required="required" readonly>
				<input type="hidden" name="creator-craft-id" id="creator-craft-id" value="0">
			</div>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<div class="col-sm-offset-1 col-sm-1">
				<img id="gbr-view<?php _e($i); ?>" src="" alt="" class="gambar-view-craft" height="50">
			</div>
			<div class="col-sm-3">
				<input id="gbr-fname<?php _e($i); ?>" type="text" name="gambar-url-craft[]" class="form-control gambar-url-craft" readonly="readonly" >
				<input id="gbr-id<?php _e($i); ?>" type="hidden" name="gambar-id-craft[]" value="0" class="gambar-id-craft">
			</div>
			<div class="col-sm-1">
			...
			<div class="col-sm-2">
				<input id="gbr-radio<?php _e($i); ?>" class='gambar-utama-craft' type='radio' name='gambar-utama-craft' value='0'> gambar utama
			</div>
		</div>
		<?php endfor; ?>
		<div class="form-group">
			...
			$.post(
				...
				function( response ) {
					...
					if( result.status ) {
						...
						//reset_form_craft();
						location.href = "<?php echo admin_url('admin.php?page=sltg-craft&doaction=create-new&status=success'); ?>";
					}else{
