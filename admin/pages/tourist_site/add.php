...
<div class="data-wrapper">
	<form class="form-horizontal" id="form-touristsite">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="nama-touristsite" class="form-control" id="nama-touristsite" placeholder="nama" required="required">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="alamat-touristsite">Address <strong>*</strong></label>
			<div class="col-sm-4">
				<textarea name="alamat-touristsite" class="form-control" id="alamat-touristsite"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="deskripsi-touristsite">Description</label>
			<div class="col-sm-4">
				<textarea name="deskripsi-touristsite" class="form-control" id="deskripsi-touristsite"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="info-lain-touristsite">Info</label>
			<div class="col-sm-4">
				<textarea name="info-lain-touristsite" class="form-control" id="info-lain-touristsite"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="telp-touristsite">Telp</label>
			<div class="col-sm-4">
				<input type="number" name="telp-touristsite" class="form-control" id="telp-touristsite" placeholder="telp">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="latitude-touristsite">Latitude</label>
			<div class="col-sm-4">
				<input type="text" name="latitude-touristsite" class="form-control" id="latitude-touristsite" pattern="-?[0-9]{1,2}[\.][0-9]{1,6}">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="longitude-touristsite">Longitude</label>
			<div class="col-sm-4">
				<input type="text" name="longitude-touristsite" class="form-control" id="longitude-touristsite"  pattern="-?[0-9]{1,3}[\.][0-9]{1,6}">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="kategori-touristsite">Category <strong>*</strong></label>
			<div class="col-sm-4">
				<input type="text" name="kategori-touristsite" class="form-control" id="kategori-touristsite" placeholder="kategori" required="required">
				<input type="hidden" name="kategori-touristsite-id" id="kategori-touristsite-id" value="0">
			</div>
			<div class="col-sm-2">
		...
		<div class="form-group">
			<div class="col-sm-offset-1 col-sm-1">
				<img id="gbr-view<?php _e($i); ?>" src="" alt="" class="gambar-view-touristsite" height="50">
			</div>
			<div class="col-sm-3">
				<input id="gbr-fname<?php _e($i); ?>" type="text" name="gambar-url-touristsite[]" class="form-control gambar-url-touristsite" readonly="readonly" >
				<input id="gbr-id<?php _e($i); ?>" type="hidden" name="gambar-id-touristsite[]" value="0" class="gambar-id-touristsite">
			</div>
			<div class="col-sm-1">
			...
			<div class="col-sm-2">
				<input id="gbr-radio<?php _e($i); ?>" class='gambar-utama-touristsite' type='radio' name='gambar-utama-touristsite' value='0'> gambar utama
			</div>
		</div>
		<?php endfor; ?>
		<div class="form-group">
			...
			$.post(
				...
				function( response ) {
					...
					if( result.status ) {
						...
						location.href = "<?php echo admin_url('admin.php?page=sltg-touristsite&doaction=create-new&status=success'); ?>";
					}else{
