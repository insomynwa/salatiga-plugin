<?php
	...
	if( isset( $_POST[ 'submit-kattouristsite' ] ) ) {
		...
		if( $get_post_nama!="" && $get_post_nama!=$kattouristsite->GetNama() ) {
			$kattouristsite->SetNama( $get_post_nama );
			$result = $kattouristsite->Update();
...
<h3>Edit Tourist Site Category </h3>
<div class="data-wrapper">
	<form class="form-horizontal" id="form-kattouristsite" method="post" action="#">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" value="<?php _e( $kattouristsite->GetNama() ); ?>" name="nama-kattouristsite" class="form-control" id="nama-kattouristsite" placeholder="nama" required="required">
			</div>
		</div>
		<div class="form-group">
