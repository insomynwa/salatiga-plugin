	...
	<div class="plugin-data-filter row">
		...
		<div class="col-sm-2">
			...
			<select id="data-limit" class="">
				<option value="3" <?php if( get_option( 'katprodukukm_list_limit' ) == 3 ) _e( "selected='selected'" ); ?> >3</option>
...
jQuery(document).ready( function($) {
	...
	/*var pagination = new Pagination( "katprodukukm", limit, searchfor, "#plugin-data-pagination");
	pagination.retrieve();*/
	...
	/*function searchFor( search, target_element) {
		...
		$.get( sltg_ajax.ajaxurl,
			{
				action: 'SearchFor',
				listfor: 'katprodukukm', page: current_page, limit: limit, search: search
			},
			function (response) {
