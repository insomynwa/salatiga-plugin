...
<div class="data-wrapper">
	<form class="form-horizontal" id="form-music">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="title-music" class="form-control" id="title-music" placeholder="title" required="required">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="source-music">Source <strong>*</strong></label>
			<div class="col-sm-4">
				<input type="text" name="source-music" class="form-control" id="source-music" placeholder="(soundcloud)" required="required">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="deskripsi-music">Description</label>
			<div class="col-sm-4">
				<textarea name="deskripsi-music" class="form-control" id="deskripsi-music"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="genre-music">Genre <strong>*</strong></label>
			<div class="col-sm-4">
				<input type="text" name="genre-music" class="form-control" id="genre-music" placeholder="genre" required="required">
				<input type="hidden" name="genre-music-id" id="genre-music-id" value="0">
			</div>
			<div class="col-sm-2">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" name="creator-music" class="form-control" id="creator-music" placeholder="creator (Soekarno) " required="required" readonly>
				<input type="hidden" name="creator-music-id" id="creator-music-id" value="0">
			</div>
			<div class="col-sm-2">
			...
			$.post(
				...
				function( response ) {
					...
					if( result.status ) {
						...
						location.href = "<?php echo admin_url('admin.php?page=sltg-music&doaction=create-new&status=success'); ?>";
					}else{
