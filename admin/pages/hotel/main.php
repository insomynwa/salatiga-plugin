	...
	<div class="plugin-data-filter row">
		...
		<div class="col-sm-2">
			...
			<select id="data-limit" class="">
				<option value="1" <?php if( get_option( 'hotel_list_limit' ) == 1 ) _e( "selected='selected'" ); ?> >1</option>
				<option value="10" <?php if( get_option( 'hotel_list_limit' ) == 10 ) _e( "selected='selected'" ); ?> >10</option>
				<option value="25" <?php if( get_option( 'hotel_list_limit' ) == 25 ) _e( "selected='selected'" ); ?> >25</option>
			</select>
		</div>
	</div>
